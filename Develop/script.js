...
//     var key = saveBtn.parent().attr("id");
//  console.log();    
var siblingElement = this.previousElementSibling;

console.log(siblingElement.val());
...
//     localStorage.setItem(parentId, input);
    ...
    // Key equals the div id of the parent
    
    // Value equals the textarea.value that's the sibling of the save button
  })
